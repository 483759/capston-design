...
<div id="wrapper">
    ...
    <section id="intro" class="main">
        ...
        <table>
            ...
            <tr>
                <td>증상</td><td>발열, 권태감, 기침, 호흡곤란 및 폐렴 등 경증에서 중증까지 다양한 호흡기감염증이 나타남<br>
                그 외 가래, 인후통, 두통, 객혈과 오심, 설사 등도 나타남</td>
            </tr>
            <tr>
                <td>잠복기</td>
                <td>1~14일 (평균 4~7일)</td>
        ...
        <table>
            ...
            <tr>
                ...
                <td>의사환자는 확진환자 접촉자 중 유증상자로 코로나바이러스감염증-19 감염가능성이 높은 경우이고, 조사대상 유증상자는 의사환자보다 위험도는 낮은
                    것으로 판단되나 국외 방문력, 국내 집단발생과 역학적 연관성, 의사소견에 따라 코로나바이러스감염증-19 임상증상으로 코로나바이러스감염증-19
                    감염이 의심되는 경우입니다.
                    <br><br>
